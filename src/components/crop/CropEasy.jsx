...
export default function CropEasy({photo, setOpenCrop}) {
    const userState = useSelector(state => state.user);
    const dispatch = useDispatch();
    const queryClient = useQueryClient();
    const [crop, setCrop] = useState({ x: 0, y: 0 });
    const [zoom, setZoom] = useState(1);    //1 means 100 percent
  ...
  return (
    <div className="fixed z-[1000] inset-0  flex justify-center p5 overflow-auto">
